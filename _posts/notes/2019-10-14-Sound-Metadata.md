...
5449 5433 0000 0043 0000 0041 6c6c 2073 6f75 6e64 2065 6666 6563 7473 2061 7265 2063 6f70 7972 6967 6874 2042 4f4f 4d20 4c69 6272 6172 7920 2d20 616c 6c20 7269 6768 7473 2072 6573 6572 7665 64
...
```
4c49 5354 ec00 0000 494e 464f 4947 4e52 1000 0000 5573 6572 2049 6e74 6572 6661 6365 0000 4941 5254 0e00 0000 424f 4f4d 204c 6962 7261 7279 0000
...
4943 4f50 3200 0000 3230 3138 2042 4f4f 4d20 4c69 6272 6172 7920 284d 6f64 6572 6e20 5549 2920 7777 772e 626f 6f6d 6c69 6272 6172 792e 636f 6d00 
...
| Product Name                       | Price              | Mac OS          | Windows                                                | Demo     | Copy Protection                  | Embed                 | Batch Metadata | Search Style | \# of Databases | Playlists | Text Database Import | Text Database Export | Number of Fields                            | Custom Fields | BEXT Read | BEXT Write | ID3 Read | ID3 Write | iXML Read | iXML Write | Multi\-channel? | Advanced Search | Transfer to DAW                | In\-App Editing or Processing | Max Sampling Rate                      | Sample Rate Conversion | ReWire     | Plug\-in Support |
|------------------------------------|--------------------|-----------------|--------------------------------------------------------|----------|----------------------------------|-----------------------|----------------|--------------|-----------------|-----------|----------------------|----------------------|---------------------------------------------|---------------|-----------|------------|----------|-----------|-----------|------------|-----------------|-----------------|--------------------------------|-------------------------------|----------------------------------------|------------------------|------------|------------------|
| Soundminer Standard                | $599\.00           | 10\.7\-10\.12   |                                                        | 30 days  | iLok, HASP                       | √                     |                | Database     | ∞               | √         | √                    | √                    | 64\*                                        |               | √         | √          | √        | √         | √         | √          | √               | √               | Drag\-and\-Drop, Bin, Timeline |                               | 192 kHz/24\-bit                        | √                      | 2\-channel |                  |
| Soundminer vPro                    | $899\.00           | 10\.7\-10\.12   |                                                        | 30 days  | iLok, HASP                       | √                     | √              | Database     | ∞               | √         | √                    | √                    | 64\*                                        |               | √         | √          | √        | √         | √         | √          | √               | √               | Drag\-and\-Drop, Bin, Timeline | √                             | 192 kHz/24\-bit                        | √                      | 6\-channel | VST              |
| Soundminer HD Basic                | $199\.00           | 10\.5\+         | XP, Vista, 7, 10                                       | 30 days  | iLok, HASP                       | Category, Description |                | Database     | 2               | √         | √                    | √                    | Selection from 64                           |               | √         | √          | √        | √         | √         | √          | √               |                 | Bin, Drag\-and\-Drop           |                               | 48 kHz/24\-bit                         | √                      |            |                  |
| Soundminer HD Plus                 | $399\.00           | 10\.5\+         | XP, Vista, 7, 10                                       | 30 days  | iLok, HASP                       | √                     |                | Database     | ∞               | √         | √                    | √                    | Selection from 64                           |               | √         | √          | √        | √         | √         | √          | √               |                 | Drag\-and\-Drop, Bin, Timeline |                               | 192 kHz, 48 kHz/24\-bit export         | √                      |            |                  |
| Basehead 4\.x                      | $249\.00           | 10\.9 \- 10\.12 | XP\*, Vista\*, 7, 8                                    | √        | USB, CMStick, iLok, System Drive | 1                     |                | Database     | ∞               | √         |                      |                      | Varies by Type                              |               | √         | √          | √        | √         | √         | √          | √               | √               | Drag\-and\-Drop                |                               | 192 kHz/32\-bit, 48 kHz/24\-bit export | √                      |            |                  |
| Basehead 4\.x Lite                 | $399\.00           | 10\.9 \- 10\.12 | XP\*, Vista\*, 7, 8                                    | √        | USB, CMStick, iLok, System Drive | 1                     |                | Database     | ∞               | √         |                      |                      | Varies by Type                              |               | √         | √          | √        | √         | √         | √          | √               | √               | Drag\-and\-Drop, Bin, Timeline |                               | 192 kHz/32\-bit, 48 kHz/24\-bit export | √                      |            | VST              |
| Basehead 4\.x Ultra                | $549\.00           | 10\.9 \- 10\.12 | XP\*, Vista\*, 7, 8                                    | √        | USB, CMStick, iLok, System Drive | √                     | √              | Database     | ∞               | √         |                      |                      | Varies by Type                              |               | √         | √          |          | √         | √         | √          | √               | √               | Drag\-and\-Drop, Bin, Timeline | √                             | 192 kHz/32\-bit                        | √                      | 6\-channel | VST              |
| Soundly                            | Free, $14\.95\+    | 10\.6\.8\+      | XP\+                                                   |          | Login                            | √                     | √              | Database     | 1               | √         | √                    | √                    | 2                                           |               | √         | √          | √        |           | √         | √          | √               | √               | Drag\-and\-Drop, Timeline      |                               | 192 kHz/32\-bit                        | √                      | 2\-channel |                  |
| Resonic Pro                        | €69\.00            |                 | 7, 8, 10                                               | √        | Serial Number                    |                       |                | Database     | √               | √         |                      |                      |                                             |               | √         |            | √        |           | √         |            | √               |                 | Drag\-and\-Drop                | √                             | 192 kHz/32\-bit                        | √                      |            |                  |
| Library Monkey                     | $129\.00           | 10\.4\+         |                                                        | √        | Serial Number                    |                       | √              | Database     | ∞               | √         | √                    | √                    | Varies by Type                              | 30            | √         |            | √        | √         |           |            | √               | √               | Bin                            |                               | 192 kHz/32\-bit                        | √                      |            |                  |
| Library Monkey Pro                 | $449\.00           | 10\.4\+         |                                                        | √        | Serial Number                    |                       | √              | Database     | ∞               | √         | √                    | √                    | Varies by Type                              | 30            | √         |            | √        | √         |           |            | √               | √               | Bin, Timeline                  | √                             | 192 kHz/32\-bit                        | √                      |            | AU, VST          |
| AudioFinder                        | $69\.95            | 10\.4\+         |                                                        | √        | Serial Number                    |                       |                | Database     | 1               | √         | √                    |                      | ?                                           | 20            | ?         |            | √        |           |           |            | ?               | √               | Timeline                       | √                             | ?                                      | √                      |            | ?                |
| iTunes                             | Free               | 10\.9\+         | 7\+                                                    |          |                                  | √                     | √              | Database     | 1               | √         | √                    | √                    | Varies by Type                              |               |           |            | √        | √         |           |            |                 | √               | Drag\-and\-Drop                |                               | 192 kHz/24\-bit                        | √                      |            |                  |
| Metadigger                         | Free               | ?               | ?                                                      |          |                                  |                       |                | Database     | Multiple        | √         | √                    | √                    | 1 \(No embedding\)                          |               | √         |            | √        |           |           |            |                 |                 |                                |                               | 96 kHz/24\-bit\*                       |                        |            |                  |
| Aural Probe                        | Free               |                 | Vista, 7, 8                                            |          |                                  |                       |                | Database     | 1               | √         |                      |                      |                                             |               |           |            |          |           |           |            |                 |                 | Drag\-and\-Drop                |                               | ?                                      |                        |            |                  |
| Sample Librarian                   | €30\.00            |                 | XP, Vista, 7                                           | 30 days  | Serial Number                    |                       |                | Database     | 1               | √         |                      | √                    | 2 \(No embedding\)                          |               |           |            |          |           |           |            | √               | √               | Drag\-and\-Drop                |                               | 48 kHz/32\-bit\*                       |                        |            |                  |
| SampleSort                         | Free               |                 | Vista, 7, 8, 10                                        |          |                                  |                       |                | Database     | 1               |           |                      | √                    | \(No embedding\)                            |               |           |            |          |           |           |            | √               | √               | Drag\-and\-Drop                |                               | 192 kHz/32\-bit                        |                        |            |                  |
...
| Remetacator                        | Free               | 10\.3\+         |                                                        |          | Serial Number                    | √                     | √              | Single File  |                 |           |                      |                      | 31                                          |               | √         | √          |          |           | √         | √          |                 |                 |                                |                               | 192 kHz/24\-bit                        |                        |            |                  |
| TwistedWave                        | $79\.90            | 10\.6\+         |                                                        | 30 days  | Serial Number                    | √                     |                | Single File  |                 |           |                      |                      | 30                                          |               | √         | √          | √        | √         |           |            | √               |                 |                                | √                             | 192 kHz/32\-bit                        | √                      |            | AU, VST          |
| Wave Agent                         | Free               | 10\.4\+         | XP, Vista, 7                                           |          |                                  | √                     |                | Single File  |                 |           |                      | √                    | 7                                           |               | √         | √          |          |           | √         | √          | √               |                 |                                |                               | 96 kHz/24\-bit\*                       | √                      |            |                  |
| BWF\-Widget                        | $49\.95 \- $99\.00 |                 | 2000, XP, 9                                            |          | Serial Number                    | √                     | √              | Single File  |                 |           | √                    | √                    |                                             |               | √         | √          |          |           | √         | √          |                 |                 |                                |                               |                                        |                        |            |                  |
| BWF MetaEdit                       | Free               | 10\.6\-10\.9    | XP, Vista, 7, 8                                        |          |                                  | √                     |                | Single File  |                 |           |                      | √                    | Varies by Type                              |               | √         | √          |          |           | √         | √          |                 |                 |                                |                               | 96 kHz/24\-bit\*                       |                        |            |                  |
| Commenteer                         | $13\.99            | 10\.6\.8\+      |                                                        |          | Mac App Store                    | √                     | √              | Single File  |                 |           | √                    | √                    | 1                                           |               |           |            |          |           |           |            |                 |                 |                                |                               |                                        |                        |            |                  |
|                                    |                    |                 |                                                        |          |                                  |                       |                |              |                 |           |                      |                      |                                             |               |           |            |          |           |           |            |                 |                 |                                |                               |                                        |                        |            |                  |
| Snapper                            | $79\.00            | 10\.9\.5\+      |                                                        | 100 days | Serial Number                    |                       |                | Single File  |                 |           |                      |                      |                                             |               | √         |            | √        |           |           |            | √               |                 | Drag\-and\-Drop, Timeline      |                               | 192 kHz                                | √                      |            |                  |
