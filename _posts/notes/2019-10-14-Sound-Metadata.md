...
|------------------------------------|--------------------|-----------------|--------------------------------------------------------|----------|----------------------------------|-----------------------|------------|--------------|-----------|-----------|----------------|----------------|---------------------------------------------|---------------|-----------|------------|----------|-----------|-----------|------------|-------------|------------|--------------------------------|-------------------------------|----------------------------------------|------------------------|------------|------------------|
| Soundminer Standard                | $599\.00           | 10\.7\-10\.12   |                                                        | 30 days  | iLok, HASP                       | √                     |            | DB           | ∞         | √         | √              | √              | 64\*                                        |               | √         | √          | √        | √         | √         | √          | √           | √          | Drag\-and\-Drop, Bin, Timeline |                               | 192 kHz/24\-bit                        | √                      | 2\-channel |                  |
| Soundminer vPro                    | $899\.00           | 10\.7\-10\.12   |                                                        | 30 days  | iLok, HASP                       | √                     | √          | DB           | ∞         | √         | √              | √              | 64\*                                        |               | √         | √          | √        | √         | √         | √          | √           | √          | Drag\-and\-Drop, Bin, Timeline | √                             | 192 kHz/24\-bit                        | √                      | 6\-channel | VST              |
| Soundminer HD Basic                | $199\.00           | 10\.5\+         | XP, Vista, 7, 10                                       | 30 days  | iLok, HASP                       | Category, Description |            | DB           | 2         | √         | √              | √              | Selection from 64                           |               | √         | √          | √        | √         | √         | √          | √           |            | Bin, Drag\-and\-Drop           |                               | 48 kHz/24\-bit                         | √                      |            |                  |
| Soundminer HD Plus                 | $399\.00           | 10\.5\+         | XP, Vista, 7, 10                                       | 30 days  | iLok, HASP                       | √                     |            | DB           | ∞         | √         | √              | √              | Selection from 64                           |               | √         | √          | √        | √         | √         | √          | √           |            | Drag\-and\-Drop, Bin, Timeline |                               | 192 kHz, 48 kHz/24\-bit export         | √                      |            |                  |
| Basehead 4\.x                      | $249\.00           | 10\.9 \- 10\.12 | XP\*, Vista\*, 7, 8                                    | √        | USB, CMStick, iLok, System Drive | 1                     |            | DB           | ∞         | √         |                |                | Varies by Type                              |               | √         | √          | √        | √         | √         | √          | √           | √          | Drag\-and\-Drop                |                               | 192 kHz/32\-bit, 48 kHz/24\-bit export | √                      |            |                  |
| Basehead 4\.x Lite                 | $399\.00           | 10\.9 \- 10\.12 | XP\*, Vista\*, 7, 8                                    | √        | USB, CMStick, iLok, System Drive | 1                     |            | DB           | ∞         | √         |                |                | Varies by Type                              |               | √         | √          | √        | √         | √         | √          | √           | √          | Drag\-and\-Drop, Bin, Timeline |                               | 192 kHz/32\-bit, 48 kHz/24\-bit export | √                      |            | VST              |
| Basehead 4\.x Ultra                | $549\.00           | 10\.9 \- 10\.12 | XP\*, Vista\*, 7, 8                                    | √        | USB, CMStick, iLok, System Drive | √                     | √          | DB           | ∞         | √         |                |                | Varies by Type                              |               | √         | √          |          | √         | √         | √          | √           | √          | Drag\-and\-Drop, Bin, Timeline | √                             | 192 kHz/32\-bit                        | √                      | 6\-channel | VST              |
| Soundly                            | Free, $14\.95\+    | 10\.6\.8\+      | XP\+                                                   |          | Login                            | √                     | √          | DB           | 1         | √         | √              | √              | 2                                           |               | √         | √          | √        |           | √         | √          | √           | √          | Drag\-and\-Drop, Timeline      |                               | 192 kHz/32\-bit                        | √                      | 2\-channel |                  |
| Resonic Pro                        | €69\.00            |                 | 7, 8, 10                                               | √        | Serial Number                    |                       |            | DB           | √         | √         |                |                |                                             |               | √         |            | √        |           | √         |            | √           |            | Drag\-and\-Drop                | √                             | 192 kHz/32\-bit                        | √                      |            |                  |
| Library Monkey                     | $129\.00           | 10\.4\+         |                                                        | √        | Serial Number                    |                       | √          | DB           | ∞         | √         | √              | √              | Varies by Type                              | 30            | √         |            | √        | √         |           |            | √           | √          | Bin                            |                               | 192 kHz/32\-bit                        | √                      |            |                  |
| Library Monkey Pro                 | $449\.00           | 10\.4\+         |                                                        | √        | Serial Number                    |                       | √          | DB           | ∞         | √         | √              | √              | Varies by Type                              | 30            | √         |            | √        | √         |           |            | √           | √          | Bin, Timeline                  | √                             | 192 kHz/32\-bit                        | √                      |            | AU, VST          |
| AudioFinder                        | $69\.95            | 10\.4\+         |                                                        | √        | Serial Number                    |                       |            | DB           | 1         | √         | √              |                | ?                                           | 20            | ?         |            | √        |           |           |            | ?           | √          | Timeline                       | √                             | ?                                      | √                      |            | ?                |
| iTunes                             | Free               | 10\.9\+         | 7\+                                                    |          |                                  | √                     | √          | DB           | 1         | √         | √              | √              | Varies by Type                              |               |           |            | √        | √         |           |            |             | √          | Drag\-and\-Drop                |                               | 192 kHz/24\-bit                        | √                      |            |                  |
| Metadigger                         | Free               | ?               | ?                                                      |          |                                  |                       |            | DB           | Multiple  | √         | √              | √              | 1 \(No embedding\)                          |               | √         |            | √        |           |           |            |             |            |                                |                               | 96 kHz/24\-bit\*                       |                        |            |                  |
| Aural Probe                        | Free               |                 | Vista, 7, 8                                            |          |                                  |                       |            | DB           | 1         | √         |                |                |                                             |               |           |            |          |           |           |            |             |            | Drag\-and\-Drop                |                               | ?                                      |                        |            |                  |
| Sample Librarian                   | €30\.00            |                 | XP, Vista, 7                                           | 30 days  | Serial Number                    |                       |            | DB           | 1         | √         |                | √              | 2 \(No embedding\)                          |               |           |            |          |           |           |            | √           | √          | Drag\-and\-Drop                |                               | 48 kHz/32\-bit\*                       |                        |            |                  |
| SampleSort                         | Free               |                 | Vista, 7, 8, 10                                        |          |                                  |                       |            | DB           | 1         |           |                | √              | \(No embedding\)                            |               |           |            |          |           |           |            | √           | √          | Drag\-and\-Drop                |                               | 192 kHz/32\-bit                        |                        |            |                  |
